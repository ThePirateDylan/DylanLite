...
def language_invoker_choice(params):
	...
	addon_xml = kodi_utils.translate_path('special://home/addons/plugin.video.pirate/addon.xml')
...
def addon_icon_choice(params):
	...
	if set_icon: new_name = set_icon
		...
		try:
			...
			if not all_icons: kodi_utils.ok_dialog(heading='The Pirate Icon Images', text='Error Fetching Icon Images')
		...
		except: return kodi_utils.ok_dialog(heading='The Pirate Icon Images', text='Error Fetching Addon Icon Images') 
