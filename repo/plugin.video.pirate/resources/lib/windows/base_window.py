...
class FontUtils:
	def execute_custom_fonts(self, skin_files=[]):
		...
		skin_files = skin_files or kodi_utils.list_dirs(kodi_utils.translate_path('special://home/addons/plugin.video.pirate/resources/skins/Default/1080i/'))[1]
	...
	def replace_font(self, window, replacement_values):
		file = kodi_utils.translate_path('special://home/addons/plugin.video.pirate/resources/skins/Default/1080i/' + window)
...
class ExtrasUtils:
	...
	def run(self):
		...
		file = kodi_utils.translate_path('special://home/addons/plugin.video.pirate/resources/skins/Default/1080i/%s' % skin_file)
				        ...
				        <control type="fixedlist" id="{container_no}">
				            ...
				            <focusedlayout height="360" width="236">
				                <control type="image">
				                    ...
				                    <height>350</height>
				                    <width>236</width>
				                    <texture colordiffuse="FF3FA9FF">fenlight_diffuse/poster-50.png</texture>
				        ...
				        <control type="panel" id="{container_no}">
				            ...
				            <focusedlayout height="380" width="590">
				                <control type="image">
				                    <height>360</height>
				                    <width>580</width>
				                    <texture colordiffuse="FF3FA9FF" border="30">fenlight_common/circle.png</texture>
				                </control>
				                <control type="textbox">
				                    <top>15</top>
				                    <left>20</left>
...
<window>
    ...
    <controls>
        <control type="group">
            ...
            <height>1080</height>
            <control type="image">
                <texture colordiffuse="FF0F1828">fenlight_common/white.png</texture>
            </control>
                        ...
                        <control type="fixedlist" id="{container_no}">
                            ...
                            <focusedlayout height="360" width="392">
                                <control type="image">
                                    ...
                                    <height>296</height>
                                    <width>393</width>
                                    <texture colordiffuse="FF3FA9FF">fenlight_diffuse/landscape.png</texture>
                                    <visible>Control.HasFocus({container_no}) | Control.HasFocus({scrollbar_no})</visible>
                                </control>
                                <control type="image">
                                    <left>8</left>
